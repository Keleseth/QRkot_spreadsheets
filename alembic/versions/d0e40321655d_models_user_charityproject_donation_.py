"""Models: User, CharityProject, Donation. Initial migration

Revision ID: d0e40321655d
Revises: 
Create Date: 2024-12-28 15:08:17.881240
...
def upgrade():
    ...
    sa.CheckConstraint('LENGTH(description) > 0', name='min_descrip_length'),
    sa.CheckConstraint('LENGTH(name) > 0', name='min_name_length'),
    sa.CheckConstraint('full_amount > 0', name='positive_amount'),
